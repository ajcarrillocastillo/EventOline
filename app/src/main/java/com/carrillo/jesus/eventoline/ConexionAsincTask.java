...
public class ConexionAsincTask extends AsyncTask<String, String, String> {
    ...
    public ConexionAsincTask(Context myContext, String id) {
        this.id = id;
                ...
                if (jsonCompleto.has("acontecimiento")) {
                    ...
                    if (jsonCompleto.has("eventos")) {
                        ...
                        for (int i = 0; i < jsonEventoArray.length(); i++) {
                            ...
                            String inico = (jsoneventoObjeto.has("inicio") ? jsoneventoObjeto.getString("inicio") : "");
                    ...
                    if(db != null){
                        ...
                        db.execSQL("INSERT INTO `acontecimiento` (`id`, `nombre`, `organizador`, `descripcion`, `tipo`, `portada`, `inicio`, `fin`, `direccion`, `localidad`, `cod_postal`, `provincia`, `longitud`, `altitud`, `telefono`, `email`, `web`, `facebook`, `twitter`, `instagram`) " +
                                "VALUES ('"+id+"', '"+nombreAcontecimiento+"','"+organizador+"', '"+descripcion+"', '"+tipo+"', '"+portada+"', '"+inicio+"', '"+fin+"', '"+direccion+"', '"+localidad+"', '"+codPostal+"', '"+provincia+"', '"+longitud+"', '"+altitud+"', '"+telefono+"', '"+email+"', '"+web+"', '"+facebook+"', '"+twitter+"','"+instagram+"');");
